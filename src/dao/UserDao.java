...
public class UserDao {
	...
	public static void changeSecuritQuestion(String email, String password, String securityQuestion, String answer) {
		try {
			ResultSet rs = DbOperations
					.getData("select *from user where email='" + email + "' and password = '" + password + "'");
			if (rs.next()) {
	...
	public static void update(String email, String securityQuestion, String answer) {
		...
		DbOperations.setDataOrDelete(query, "Question Changed Successfully");
